...
const sectionData = [
    {
        title: 'أحدث العروض',
        image_3: ['عروض-شركة-فيتوريا/احدث-العروض/3.jpg', 'عروض بعد العيد (رحلات فردية)'],
        image_4: ['عروض-شركة-فيتوريا/احدث-العروض/4.jpg', 'رحلة ايطاليا & النمسا | 12 يوم'],
        image_5: ['عروض-شركة-فيتوريا/احدث-العروض/5.jpg', 'عروض بعد العيد (رحلات فردية)'],
        image_1: ['عروض-شركة-فيتوريا/احدث-العروض/1.jpg', 'رحلة باكو | 5 أيام'],
        image_2: ['عروض-شركة-فيتوريا/احدث-العروض/2.jpg', 'رحلة المالديف & سيجيريا & كاندي & جالي'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-فيتوريا/تايلاند/1.jpg', 'رحلة تايلاند بوكيت & كرابي | 11 يوم'],
        image_2: ['عروض-شركة-فيتوريا/تايلاند/2.jpg', 'رحلة تايلاند & ماليزيا | 12 يوم'],
    },

    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-فيتوريا/لندن/1.jpg', 'رحلة لندن & اسطنبول | 8 أيام'],
    },

    {
        title: 'عروض اسبانيا',
        image_1: ['عروض-شركة-فيتوريا/اسبانيا/1.jpg', 'رحلة برشلونة & بورتو & لشبونة | 10 أيام'],
        image_2: ['عروض-شركة-فيتوريا/اسبانيا/2.jpg', 'رحلة برشلونة & مراكش & كازابلانكا | 10 أيام'],
    },

    {
        title: 'عروض سريلانكا',
        image_1: ['عروض-شركة-فيتوريا/سريلانكا/1.jpg', 'رحلة كولومبو & كاندي & نواراليا | 9 أيام'],
    },

    {
        title: 'عروض موسكو',
        image_1: ['عروض-شركة-فيتوريا/موسكو/1.jpg', 'رحلة موسكو | 5 أيام'],
        image_2: ['عروض-شركة-فيتوريا/موسكو/2.jpg', 'رحلة أعياد البحرين | موسكو 7 أيام'],
        image_3: ['عروض-شركة-فيتوريا/موسكو/3.jpg', 'رحلة موسكو & سانت بطرسبرغ | 11 يوم'],
    },

    {
        title: 'عروض اسطنبول',
        image_3: ['عروض-شركة-فيتوريا/اسطنبول/3.jpg', 'رحلة بورصة & جزر الاميرات & صبنجة | 6 أيام'],
        image_1: ['عروض-شركة-فيتوريا/اسطنبول/1.jpg', 'رحلة اسطنبول | 6 أيام'],
        image_2: ['عروض-شركة-فيتوريا/اسطنبول/2.jpg', 'رحلة العيد الوطني | اسطنبول | 7 أيام'],
    },

    {
        title: 'عروض طرابزون',
        image_1: ['عروض-شركة-فيتوريا/طرابزون/1.jpg', 'رحلة طرابزون & اوزنجول -  8 أيام'],
        image_2: ['عروض-شركة-فيتوريا/طرابزون/2.jpg', 'رحلة طرابزون & اسطنبول -  8 أيام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97335101309?text=💎%20طلب%20حجز%20عرض%20جديد%20💎%0A%0Aسلام%20عليكم،%20حاب%20أسأل%20عن%20عرض%0A*${encodeURIComponent(text)}*%0Aوحاب%20أعرف%20تفاصيل%20أكثر%20عن%20عروضكم%20المشابهة.%0A%0A🔗%20رابط%20صورة%20العرض:%0Ahttps://mohammed-website.github.io/vittoriatravel/${encodeURIComponent(src)}%0A%0Aبإنتظار%20ردكم%20وشكرًا%20لكم`;
        ...
        .then(data => {
            ...
            data.reverse().forEach(item => { // Reverse to show newest first
                ...
                <div class="indoforall_clint_rate_info_div indoforall_animate_on_scroll">
                    <img src="مكتب-سياحي/مكتب-سياحي-بحريني.webp" alt="فيتوريا للسفر والسياحة - مكتب سياحي" title="فيتوريا للسفر والسياحة - مكتب سياحي">
                    <h4>${name}</h4>
                </div>
